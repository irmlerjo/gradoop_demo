...
package org.gradoop.demo.server.oldApi;
...
import org.gradoop.demo.server.CytoJSONBuilder;
...
import org.gradoop.demo.server.pojo.GroupingRequestNonTemporal;
...
public class RequestHandler {
  ...
  public Response getGraph(@PathParam("databaseName") String databaseName) throws Exception {
    ...
    String json = CytoJSONBuilder.getJSONStringNonTemporal(
  ...
  /**
   * Takes a {@link GroupingRequestNonTemporal}, executes a grouping with the parameters it contains and
   * returns the results as a JSON.
   *
   * @param request GroupingRequestNonTemporal send to the server, containing the parameters for a
   *        {@link Grouping}.
  ...
  @Path("/grouping")
  @Produces("application/json;charset=utf-8")
  public Response getData(GroupingRequestNonTemporal request) throws Exception {
  ...
  private Response getResponse(
    ...
    try {
      ...
      String json = CytoJSONBuilder.getJSONStringNonTemporal(resultHead, resultVertices, resultEdges);
      return Response.ok(json).build();
